...
#ifndef HW_VFIO_VFIO_BASE_CONTAINER_OBJ_H
#define HW_VFIO_VFIO_BASE_CONTAINER_OBJ_H
...
#define TYPE_VFIO_BASE_CONTAINER_OBJ "qemu:vfio-base-container-obj"
#define VFIO_BASE_CONTAINER_OBJ(obj) \
        OBJECT_CHECK(VFIOContainer, (obj), TYPE_VFIO_BASE_CONTAINER_OBJ)
#define VFIO_BASE_CONTAINER_OBJ_CLASS(klass) \
        OBJECT_CLASS_CHECK(VFIOContainerClass, (klass), \
                         TYPE_VFIO_BASE_CONTAINER_OBJ)
#define VFIO_BASE_CONTAINER_OBJ_GET_CLASS(obj) \
...
typedef struct VFIOContainerClass {
    ...
    int (*dma_unmap)(VFIOContainer *bcontainer,
                     hwaddr iova, ram_addr_t size,
                     IOMMUTLBEntry *iotlb);
    bool (*devices_all_dirty_tracking)(VFIOContainer *bcontainer);
    void (*set_dirty_page_tracking)(VFIOContainer *bcontainer, bool start);
    int (*get_dirty_bitmap)(VFIOContainer *bcontainer, uint64_t iova,
...
#endif /* HW_VFIO_VFIO_BASE_CONTAINER_OBJ_H */
