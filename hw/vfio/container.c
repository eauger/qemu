...
#define TYPE_VFIO_LEGACY_CONTAINER "qemu:vfio-container"
...
{
    VFIOLegacyContainer *container = container_of(bcontainer, VFIOLegacyContainer, obj);
    VFIOGroup *group;
    VFIODevice *vbasedev;
...
static int vfio_legacy_container_add_section_window(VFIOContainer *bcontainer,
...
static void vfio_legacy_container_del_section_window(VFIOContainer *bcontainer,
                                              MemoryRegionSection *section)
{
    VFIOLegacyContainer *container = container_of(bcontainer, VFIOLegacyContainer, obj);
                                  ...
                                  Error **errp)
{
    ...
    vfio_container_init(bcontainer, sizeof(*bcontainer), TYPE_VFIO_LEGACY_CONTAINER, space);
...
static void vfio_legacy_container_class_init(ObjectClass *klass,
                                             void *data)
{
    VFIOContainerClass *vccs = VFIO_BASE_CONTAINER_OBJ_CLASS(klass);
...
static const TypeInfo vfio_legacy_container_info = {
    .parent = TYPE_VFIO_BASE_CONTAINER_OBJ,
