...
#define TYPE_VFIO_CONTAINER_IOMMUFD "qemu:vfio-iommufd-container"

static int iommufd_map(VFIOContainer *bcontainer, hwaddr iova,
                       ram_addr_t size, void *vaddr, bool readonly)
{
    VFIOIOMMUFDContainer *container = container_of(bcontainer, VFIOIOMMUFDContainer, obj);
                                 ...
                                 Error **errp)
{
    ...
    vfio_container_init(bcontainer, sizeof(*bcontainer), TYPE_VFIO_CONTAINER_IOMMUFD, space);
...
static void vfio_iommufd_class_init(ObjectClass *klass,
                                    void *data)
{
    VFIOContainerClass *vlcc = VFIO_BASE_CONTAINER_OBJ_CLASS(klass);
...
static const TypeInfo vfio_iommufd_info = {
    ...
    .name = TYPE_VFIO_CONTAINER_IOMMUFD,
